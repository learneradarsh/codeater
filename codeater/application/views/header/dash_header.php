...
<nav class="navbar navbar-inverse navbar-fixed">
  ...
  <form class="navbar-form navbar-right">
     <ul class="nav navbar-nav">
      ...
      <li><a href="<?=base_url('inbox');?>">Inbox</a></li><li><span class="badge"  style="margin-top:10px; margin-right:5px" >42</span></li>
      <li>  <input type="text" class="form-control" placeholder="Search for..." style="margin-top:5px; margin-right:10px"></li>
    <li>
        <p><img src="<?=base_url('assests/');?>images/e_logo.png" class="profile-image img-circle" width="45px" height="35px"style="margin-top:5px"/></p>
